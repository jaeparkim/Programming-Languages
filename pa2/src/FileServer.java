...
public class FileServer extends UniversalActor  {
	public static void main(String args[]) {
		...
		FileServer instance = (FileServer)new FileServer(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new FileServer(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return FileServer.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new FileServer(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return FileServer.getReferenceByLocation(new UAL(ual)); }
	public FileServer(boolean o, UAN __uan)	{ super(false,__uan); }
	public FileServer(boolean o, UAL __ual)	{ super(false,__ual); }
	public FileServer(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public FileServer(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public FileServer(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public FileServer()		{  }
	public FileServer(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "src.FileServer", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		public FileServer self;
		public void updateSelf(ActorReference actorReference) {
			((FileServer)actorReference).setUAL(getUAL());
			((FileServer)actorReference).setUAN(getUAN());
			self = new FileServer(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
