...
public class Client extends UniversalActor  {
	public static void main(String args[]) {
		...
		Client instance = (Client)new Client(uan, ual,null).construct();
	...
	public static ActorReference getReferenceByName(UAN uan)	{ return new Client(false, uan); }
	public static ActorReference getReferenceByName(String uan)	{ return Client.getReferenceByName(new UAN(uan)); }
	public static ActorReference getReferenceByLocation(UAL ual)	{ return new Client(false, ual); }

	public static ActorReference getReferenceByLocation(String ual)	{ return Client.getReferenceByLocation(new UAL(ual)); }
	public Client(boolean o, UAN __uan)	{ super(false,__uan); }
	public Client(boolean o, UAL __ual)	{ super(false,__ual); }
	public Client(UAN __uan,UniversalActor.State sourceActor)	{ this(__uan, null, sourceActor); }
	public Client(UAL __ual,UniversalActor.State sourceActor)	{ this(null, __ual, sourceActor); }
	public Client(UniversalActor.State sourceActor)		{ this(null, null, sourceActor);  }
	public Client()		{  }
	public Client(UAN __uan, UAL __ual, Object obj) {
		...
		if (obj instanceof UniversalActor.State || obj==null) {
			  ...
			  if (__ual != null && !__ual.getLocation().equals(ServiceFactory.getTheater().getLocation())) {
			    ...
			    createRemotely(__uan, __ual, "src.Client", sourceRef);
			  }
	...
	public class State extends UniversalActor .State {
		...
		public void updateSelf(ActorReference actorReference) {
			((Client)actorReference).setUAL(getUAL());
			((Client)actorReference).setUAN(getUAN());
			self = new Client(false,getUAL());
			self.setUAN(getUAN());
			self.setUAL(getUAL());
			self.activateGC();
		}
			...
			if (args.length!=1) {{
				{
					...
					{
						Object _arguments[] = { "Usage: java migration.Migrate  <commands.script>" };
				...
				if (firstChar.equals("d")) {{
					{
						...
						{
							Object _arguments[] = { s };
							Message message = new Message( self, self, "createDirectoryService", _arguments, null, null );
							__messages.add( message );
						}
					}
				}
}				else {if (firstChar.equals("f")) {{
					{
						...
						{
							Object _arguments[] = { s };
							Message message = new Message( self, self, "createFileServer", _arguments, null, null );
							__messages.add( message );
						}
					}
				}
}				else {if (firstChar.equals("c")) {{
					{
						...
						{
							Object _arguments[] = { s };
							Message message = new Message( self, self, "create", _arguments, null, null );
							__messages.add( message );
						}
					}
				}
}				else {if (firstChar.equals("g")) {{
					{
						...
						{
							Object _arguments[] = { s };
							Message message = new Message( self, self, "get", _arguments, null, null );
							__messages.add( message );
						}
					}
				}
}				else {if (firstChar.equals("q")) {{
					{
						...
						{
							Object _arguments[] = { s };
							Message message = new Message( self, self, "quit", _arguments, null, null );
							__messages.add( message );
						}
					}
				}
		...
		public void createDirectoryService(String s) {
			{
				// standardOutput<-println("XXXXXXXXXXXXXXXXXXXXXXXXXXXXX\n")
				{
					Object _arguments[] = { "XXXXXXXXXXXXXXXXXXXXXXXXXXXXX\n" };
					Message message = new Message( self, standardOutput, "println", _arguments, null, null );
					__messages.add( message );
				}
			}
			...
			}
			{
				...
				{
					Object _arguments[] = { "Create Directory Service Method" };
					Message message = new Message( self, standardOutput, "println", _arguments, null, null );
					__messages.add( message );
				}
			}
			DirectoryServer a = ((DirectoryServer)new DirectoryServer(new UAN(uan_str), new UAL(ual_str),this).construct(0));
			DirectoryServer d = (DirectoryServer)DirectoryServer.getReferenceByName(uan_str);
			{
				// d<-store("filename", "string")
				{
					Object _arguments[] = { "filename", "string" };
					Message message = new Message( self, d, "store", _arguments, null, null );
					__messages.add( message );
				}
			}
		}
		public void createFileService(String s) {
